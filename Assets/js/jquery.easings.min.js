...
jQuery.effects || function(e, t) {
    ...
    function(t, i) {
        ...
        function s(e) {
            ...
            s.length ? ("0,0,0,0" === s.join() && t.extend(s, r.transparent),
            a) : r[e]
        }
        function n(e, t, i) {
            return i = (i + 1) % 1,
        ...
        u.fn = t.extend(u.prototype, {
            parse: function(n, o, h, l) {
                ...
                var c = this
                  , p = t.type(n)
                  , f = this._rgba = [];
                return o !== i && (n = [n, o, h, l],
                p = "array"),
                "string" === p ? this.parse(s(n) || r._default) : "array" === p ? (m(d.rgba.props, function(e, t) {
                    f[t.idx] = a(n[t.idx], t)
                }),
                this) : "object" === p ? (n instanceof u ? m(d, function(e, t) {
                    ...
                    c[s] && 0 > e.inArray(null, c[s].slice(0, 3)) && (c[s][3] = 1,
            ...
            is: function(e) {
                ...
                return m(d, function(e, n) {
                    var r, o = t[n.cache];
                    return o && (r = s[n.cache] || n.to && n.to(s._rgba) || [],
        ...
        m(d, function(e, s) {
            var n = s.props
              ...
              , l = s.from;
            u.fn[e] = function(e) {
                if (o && !this[r] && (this[r] = o(this._rgba)),
                e === i)
                    return this[r].slice();
            ...
            m(n, function(i, a) {
                u.fn[i] || (u.fn[i] = function(s) {
                    ...
                    r = t.type(s)),
                    null == s && a.empty ? this : ("string" === r && (n = h.exec(s),
                    n && (s = u + parseFloat(n[2]) * ("+" === n[1] ? 1 : -1))),
                    l[a.idx] = s,
                    this[o](l)))
                }
                )
    ...
    function() {
        function i() {
            ...
            if (a && a.length && a[0] && a[a[0]])
                for (i = a.length; i--; )
                    t = a[i],
                    "string" == typeof a[t] && (s[e.camelCase(t)] = a[t]);
            else
                for (t in a)
        ...
        function a(t, i) {
            ...
            for (a in i)
                s = i[a],
                t[a] !== s && (n[a] || (e.fx.step[a] || !isNaN(parseFloat(s))) && (r[a] = s));
            return r
        }
        ...
        e.effects.animateClass = function(t, n, r, o) {
            ...
            return this.queue(function() {
                ...
                l = l.map(function() {
                    ...
                    return this.el.animate(this.diff, a),
                    i.promise()
                }),
    ...
    function() {
        function s(t, i, a, s) {
            ...
            a = null,
            i = {}),
            ("number" == typeof i || e.fx.speeds[i]) && (s = a,
            a = i,
            i = {}),
            e.isFunction(a) && (s = a,
            a = null),
